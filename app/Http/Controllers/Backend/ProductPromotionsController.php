    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                // Upload the new image and update the model's image path
                $imagePath = Helper::fileUpload($request->file('image'), 'product-promotion', 'product-promotion-image');
                $ProductPromotion->image = $imagePath;
            }
