                ...
                <div class="car--search--wrapper">
                    <form action="#">
                        ...
                        <div class="input--group">
                            ...
                            <div class="date--time">
                                <div class="date">
                                    <input type="text" id="date1" class="pick--date" placeholder="1/3/2024"
                                        readonly>
                                </div>
                                <div class="time">
                                    <input type="text" id="time1" class="timepick" placeholder="10:00 AM"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input--group last">
                            ...
                            <div class="date--time">
                                <div class="date">
                                    <input type="text" id="date2" class="pick--date" placeholder="1/3/2024"
                                        readonly>
                                </div>
                                <div class="time">
                                    <input type="text" id="time2" class="timepick" placeholder="10:00 AM"
                                        readonly>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mt_30">
                        <div class="posi--img--wrapper">
                            ...
                            <img class="choose--car-desktop" src="assets/images/choose--car.png" alt="">
                            <img class="d-none choose--car-mobile" src="assets/images/choose--car-mobile.png"
                                alt="">
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="tab--links">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-available-car-tab"
                                                    data-bs-toggle="pill" data-bs-target="#pills-available-car"
                                                    type="button" role="tab" aria-controls="pills-available-car"
                                                    aria-selected="true">Available Cars Only (40)</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="pills-all-tab" data-bs-toggle="pill"
                                                    data-bs-target="#pills-all" type="button" role="tab"
                                                    aria-controls="pills-all" aria-selected="false">All Cars
                                                    (210)</button>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="testi--title">
                            ...
                            <p><strong>We are world wide corporates Brand</strong> Experience the future of automotive
                                innovation with our latest car models we offer a wide range of rental cars to suit your
                                needs. </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <p>Lorem ipsum dolor sit amet consectetur. Integer facilisi sit tortor lobortis
                                                amet. Risus vestibulum nec fringilla sed in tincidunt tempus porta.
                                                Vulputate ornare vitae turpis mauris. </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- item  -->
